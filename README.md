...
3. Dodaj, edytuj lub usuń wpis. Aplikacja waliduje zmianę, tworzy backup, aktywuje config i automatycznie restartuje cloudflared. Panel pokazuje jeden z trzech wyników: sukces, nieudana aktywacja z udanym rollbackiem albo nieudana aktywacja z nieudanym rollbackiem. Po sukcesie używa krótkiego komunikatu; przy obu rodzajach błędu pełną diagnostykę pokazuje bezpośrednio na stronie, bez zapisywania jej w sesji cookie.
